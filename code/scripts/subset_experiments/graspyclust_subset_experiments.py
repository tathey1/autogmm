...
for i in range(num_runs):
    ...
    c_hat, _, _, best_ari_bic, _ = brute_graspy_cluster(
        Ns, x, covariance_types, ks, c_true, savefigs, graph_types
    )
    results = results.append(
        {"Time": time.time() - start_time, "ARI": best_ari_bic}, ignore_index=True
    )
