...
def draw_bar_dendrogram(
    meta, ax, first_mid_map, class_label, color_map, max_comp, mat_gap, labels,
...
maximum_for_labels, heights_for_labels = draw_bar_dendrogram(
    meta_L, ax, first_mid_map, class_label, color_map, mat_gap=0.4,
...
maximum_for_labels, heights_for_labels = draw_bar_dendrogram(
    meta_R, ax, first_mid_map, class_label, color_map, mat_gap=0.6, labels=None,
    lowest_level=lowest_level, draw_labels=False, max_comp=6)
